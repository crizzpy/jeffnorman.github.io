            ...
            <animated.div key={key} style={props} >
                <Switch location={item}>
                    <Route exact path="/dashboard">
                        <BulletinBoard confirmPostDel={confirmPostDel} setConfirmPostDel={setConfirmPostDel} postsLoaded={postsLoaded} addPostOpen={addPostOpen} setAddPostOpen={setAddPostOpen} />
                    </Route>
